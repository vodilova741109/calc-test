...
let appData = {
  ...
  expensesMonth: 0,
  asking: function(){
    appData.Expenses = prompt('Перечислите возможные расходы за рассчитываемый период через запятую', ''); 
 ...
 getStatusIncome: function(){
  ...
  // period: Math.ceil(this.mission / this.accumulatedMonth),
  budgetDay: Math.floor(this.accumulatedMonth/30),
...
//   period = Math.ceil(appData.mission / appData.accumulatedMonth); 
  ...
  console.log(this.getAccumulatedMonth);
